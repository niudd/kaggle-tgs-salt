...
#                         'val_iou1': val_iou}
        ...
        if i>-1:
            ...
            logging.info('[EPOCH %05d][mask coverage all mask] train_loss, train_iou: %0.5f, %0.5f; val_loss, val_iou: %0.5f, %0.5f'%(i, train_loss.item(), train_iou.item(), val_loss.item(), val_iou.item()))
...
checkpoint_path = 'checkpoint/1010_all_mask_v1_seed%d'%SEED#seed%d_phase2, seed%d ;;; seed%d-hypercol, seed%d-hypercol-phase2
LOG_PATH = 'logging/1010_all_mask_v1_seed%d.log'%SEED#seed%d.log
